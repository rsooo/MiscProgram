...
/**
 * BluetoothTransferで使うデバイスリストダイアログ
 * 開いた瞬間にデバイス検索もする
 * @author akira
 *
 */
public class DeviceListDialogActivity extends ListActivity {
	...
	private final class DeviceDiscoveryHandler extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(ACTION_DISCOVERY_FINISHED)) {
				...
				TextView v = (TextView)getListView().getEmptyView();
				v.setText(getString(R.string.device_not_found));
				return;
			}			
		}
